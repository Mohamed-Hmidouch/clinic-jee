...
import org.example.clinicjee.repository.interfaces.UserRepositoryInterface;
...
public class UserRepository implements UserRepositoryInterface {
    ...
    public List<User> findByRoleAndActif(Role role, Boolean actif) {
        EntityManager em = JPAUtil.getEntityManager();
        try {
            TypedQuery<User> query = em.createQuery("SELECT u FROM User u WHERE u.role = :role AND u.actif = :actif ORDER BY u.fullName", User.class);
            query.setParameter("role", role);
